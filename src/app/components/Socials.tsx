    ...
    return ( 
        <main className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="flex flex-col items-center justify-center gap-4 p-4 rounded-lg shadow-sm shadow-jet border border-jet border-solid bg-smoky-black" data-aos="fade-down">
                    ...
                    <a href="mailto:soufianetangi2@gmail.com" target="_blank" className="flex flex-col items-center justify-center gap-2 group">
                        <p className="text-litewhite text-[12px] md:text-[13px] font-medium">soufianetangi2@gmail.com</p>
                ...
                <div className="flex flex-col items-center justify-center gap-4 p-4 rounded-lg shadow-sm shadow-jet border border-jet border-solid bg-smoky-black" data-aos="fade-down">
                    ...
                    <a href="https://wa.me/212632562470" target="_blank" className="flex flex-col items-center justify-center gap-2 group">
                        <p className="text-litewhite text-[12px] md:text-[13px] font-medium">+212-63-256-24-70</p>
                ...
                <div className="flex flex-col items-center justify-center gap-4 p-4 rounded-lg shadow-sm shadow-jet border border-jet border-solid bg-smoky-black" data-aos="fade-down">
                    ...
                    <h4 className="text-[14px] md:text-[16px] text-litewhite transition-all delay-200 font-medium">Morocco, Casablanca</h4>
                </div>
        </main>
     );
}
