            ...
            <section className="flex flex-col gap-5">
                ...
                <div className="relative pl-8 pr-4 border-l-[2px] border-l-jet border-l-solid ml-5 md:ml-8 mt-10 mb-10 grid gap-6">
                    ...
                    <div className="relative grid gap-2">
                        <h3 className="text-[16px] md:text-[18px] text-litewhite font-bold" data-aos="fade-down">Industrial Maintenance and Automation</h3>
                        <h4 className="text-[15px] md:text-[17px] text-litewhite" data-aos="fade-down">Automation, including Programmable Logic Controllers (PLC)</h4>
                        <h4 className="text-[14px] md:text-[16px] text-litewhite font-bold font-italic" data-aos="fade-down">Automation</h4>
                        <p className="text-[14px] md:text-[16px] text-vegas-gold" data-aos="fade-down">2020 - 2022</p>
                    ...
                    <div className="relative grid gap-2">
                        ...
                        <p className="text-[14px] md:text-[16px] text-vegas-gold" data-aos="fade-down">2023 - 2025</p>
                ...
                <div className="relative pl-8 pr-4 border-l-[2px] border-l-jet border-l-solid ml-5 md:ml-8 mt-10 mb-10 grid gap-6">
                    ...
                    <div className="relative grid gap-2">
                        <h3 className="text-[17px] md:text-[18px] text-litewhite font-bold" data-aos="fade-down">Microcontroller Programming</h3>
                        <h4 className="text-[14px] md:text-[16px] text-litewhite" data-aos="fade-down">C++ </h4>
                        <h4 className="text-[15px] md:text-[17px] text-litewhite font-bold font-italic" data-aos="fade-down">Microcontroller Programming Intern</h4>
                    ...
                    <div className="relative grid gap-2">
                        ...
                        <h4 className="text-[14px] md:text-[16px] text-litewhite" data-aos="fade-down">HTML, CSS, JavaScript, Git, Github</h4>
                        <h4 className="text-[15px] md:text-[17px] text-litewhite font-bold font-italic" data-aos="fade-down">Backend Developer Intern</h4>
                        <p className="text-[14px] md:text-[16px] text-vegas-gold" data-aos="fade-down">2025</p>
                ...
                <div className="relative pl-8 pr-4 border-l-[2px] border-l-jet border-l-solid ml-5 md:ml-8 mt-10 mb-10 grid gap-6">
                    ...
                    <div className="relative grid gap-2">
                        <h3 className="text-[16px] md:text-[18px] text-litewhite font-bold" data-aos="fade-down">Google Ads Search Certification</h3>
                        <h4 className="text-[14px] md:text-[16px] text-litewhite" data-aos="fade-down">Skills Google Ads</h4>
